                                        ...
                                        return(
                                            <div className="item-container">
                                                ...
                                                <div className="info-container">
                                                    ...
                                                    <div className="item-introduce" dangerouslySetInnerHTML={{ __html: data.introduce }}></div>
                                                    <div className="item-price">가격 : {data.price.toLocaleString()}원 </div>
                                                </div>
                                                <div className="item-checked">
                                                    <p onClick={()=>shoppingBasket(data.id-1, selectedYear, data)}>{shoppingBooks.find(book => book.name === data.name) ? "제거" : "담기" }</p>
                                                </div>
                                            </div>
                                        )
                                })}
